      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-6">
              The all-in-one marketing platform that helps businesses grow through email marketing, automation, and customer engagement.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">SMS Marketing</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            ...
            <span className="text-gray-400 text-sm">for marketers worldwide</span>
          </div>
        </div>
      </div>
    </footer>
